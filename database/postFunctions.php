...
{
	$sql = "SELECT post_id,creationDate,title,content,fullName,username,profilepic,author_id,zip FROM advanced_post WHERE inactive=0 AND post_id=:id";
	$params = [":id" => $post_id];
...
{
	$sql = "SELECT post_id,creationDate,title,content,username,fullName,profilepic,author_id,zip,lat,lon FROM advanced_post WHERE inactive=0";
...
{
	$sql = "SELECT comment_id,author_id,creationDate,parent_id,content,username,fullName,profilepic FROM advanced_comment WHERE inactive=0 AND post_id=:id AND parent_id IS NULL";
	$params = [":id" => $post_id];
...
{
	$sql = "SELECT comment_id,author_id,creationDate,parent_id,content,username,fullName,profilepic FROM advanced_comment WHERE inactive=0 AND parent_id=:id";
