			...
			<div id="nextToProfilePic">
				...
				<div id="postTitleWithDropdown">
					...
					<div class="dropdown-center dropend">
						<button
							class="commentButton btn dropdown-toggle"
							type="button"
		...
		<section id="comments">
			...
			<table id="commentTable" class="table">
				<tr id="comment1" class="comment">
					<td>
						<div class="commentDate">9/2/22 at 6:01pm</div>
						<div class="user">
							<img src="../global/blank.jpg" alt="Username1" />
							<a href="../profiles/yourProfile.html">Username1</a>
						</div>
					</td>
					<td>
						...
						<textarea
							hidden
							class="replyBox form-control"
						></textarea>
						<div class="replyActionButtons">
							<button
								hidden
								class="cancelReply btn btn-sm btn-secondary"
							>
								Cancel
							</button>
							<button
								class="replyButton btn btn-sm btn-secondary"
							>
								Reply
							</button>
						</div>
				...
				<tr id="reply1comment1" class="comment reply">
					<td>
						<div class="commentDate">9/2/22 at 6:01pm</div>
						<div class="user">
							<img src="../global/blank.jpg" alt="Username4" />
							<a href="../profiles/yourProfile.html">Username4</a>
						</div>
					</td>
					<td>
						<div><i>Replying to Username1</i></div>
				...
				<tr id="comment2" class="comment">
					<td>
						<div class="commentDate">9/2/22 at 6:01pm</div>
						<div class="user">
							<img src="../global/blank.jpg" alt="Username2" />
							<a href="../profiles/yourProfile.html">Username2</a>
						</div>
					</td>
					<td>
						<div class="commentContent">
