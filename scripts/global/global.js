(function () {
	...
	async function loadNotifications() {
		await fetch("../api/notifications/getNotifications.php")
			.then(checkStatus)
			.then((notifications) => {
	...
	function dismiss() {
		...
		fetch("../api/notifications/dismiss.php", { method: 'POST', body: data })
	...
	function accept() {
		...
		fetch("../api/notifications/accept.php", { method: 'POST', body: data })
			.then((resp) => checkStatus(resp, false))
			.then(() => {
				notification.remove();
				checkNotiCount();
	...
	function decline() {
		...
		fetch("../api/notifications/decline.php", { method: 'POST', body: data })
			.then((resp) => checkStatus(resp, false))
			.then(() => {
				notification.remove();
				checkNotiCount();
